...
export default function TransactionDetail() {
    ...
    const fetchDetail = async () => {
        try {
            const response = await fetch(`http://${import.meta.env.VITE_SERVER_IP}/api/TransactionDetail`, {
                method: 'POST',
                headers: {
    ...
    const FindPerson = async () => {
        try {
            const response = await fetch(`http://${import.meta.env.VITE_SERVER_IP}/api/FindPerson`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const Update = async () => {
        try {
            const response = await fetch(`http://${import.meta.env.VITE_SERVER_IP}/api/Update`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
