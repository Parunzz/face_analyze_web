...
function Emotion_Detail() {
  ...
  async function getResponseText() {
    let url = `http://${import.meta.env.VITE_SERVER_IP}/api/ResponseText`;
    try {
  ...
  async function handleSubmit(event) {
    ...
    let url = `http://${import.meta.env.VITE_SERVER_IP}/api/SetResponseText`;
    try {
  ...
  async function removeResponseText(response_text_id) {
    const url = `http://${import.meta.env.VITE_SERVER_IP}/api/removeResponseText/${response_text_id}`;
    try {
